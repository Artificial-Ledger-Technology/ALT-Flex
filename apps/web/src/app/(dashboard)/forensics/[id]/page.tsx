...
// Define the Next.js page props interface. Next.js 15 passes `params` as a
...
export default async function ForensicsReportPage({
  params,
      ...
      detected: [
        {
          ...
          confidence: 0.98,
          description:
            'Identified a large, uncollateralized loan that was borrowed and repaid within the same transaction.',
          narrative:
            'A flash loan of 100,000 USDC was initiated from Aave V3 Pool, providing the attacker with temporary capital to execute market manipulation.',
          evidence: {
        ...
        },
        {
          ...
          confidence: 0.85,
          description:
            'Significant price slippage detected on a decentralized exchange immediately preceding a liquidation call.',
          narrative:
            'The attacker skewed the Uniswap V3 USDC/TokenX pool ratio, causing the TWAP oracle to report an artificially low price for TokenX.',
          evidence: {
        ...
        },
        {
          ...
          confidence: 0.32,
          description:
            'A fallback function was triggered, but no state mutations occurred during the callback.',
          narrative:
            'Minor reentrant call detected during ETH transfer, but state locks prevented exploit.',
          evidence: {
            callNodeIds: ['node-25'],
            storageSlots: [],
            eventSignatures: [],
