...
export default function ForensicTracePage() {
  return (
    <div
      style={{ padding: 'var(--spacing-6)', display: 'flex', flexDirection: 'column', gap: '40px' }}
    >
      <div style={{ height: '800px' }}>
        <TraceViewer traceResult={mockTraceData} />
      </div>
      <div>
        <StorageDiffInspector
          storageDiffs={mockStorageDiffs}
          globalSummary={mockGlobalDiffSummary}
        />
      </div>
    </div>
  );
