...
- **🚨 Alert Red** (`#EF4444`)
  - **Usage:** Detected exploits, malicious skills, critical system errors.
...
- **Glassmorphism:** Subtle transparent overlays with blur effects to create depth without cluttering the interface.
- **Gradients:** Smooth transitions (e.g., Forensic Blue to Abyss Black) to give a sophisticated tech feel.
- **Component Styling:** Consistent border-radius and token-based spacing for cards (HackCard, SkillCard), ensuring a unified UI language across both Engine α (Hacks) and Engine β (Skills).
